package com.yision.fluidlogistics.content.fluids.faucet.network;
...
public class FaucetDripParticlePacket extends SimplePacketBase {

    private final BlockPos faucetPos;
    private final FluidStack fluid;

    public FaucetDripParticlePacket(BlockPos faucetPos, FluidStack fluid) {
        this.faucetPos = faucetPos;
        this.fluid = fluid;
    }

    public FaucetDripParticlePacket(FriendlyByteBuf buffer) {
