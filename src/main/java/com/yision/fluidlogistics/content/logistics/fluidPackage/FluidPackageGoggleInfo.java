...
public final class FluidPackageGoggleInfo {
    ...
    public static boolean append(List<Component> tooltip, List<FluidStack> fluids, int capacity) {
        ...
        for (FluidStack fluid : displayedFluids) {
            ...
            CreateLang.builder().add(amountLine(fluid.getAmount(), capacity)).forGoggles(tooltip, 1);
        }
        return true;
    }
