...
public class FluidLogisticsMixinPlugin implements IMixinConfigPlugin {
    ...
    /**
     * Mixins that the hand pointer runtime depends on. These must always apply
     * regardless of the advanced logistics config, so they are intentionally
     * kept out of {@link #ADVANCED_LOGISTICS_MIXINS}. The set exists only for
     * documentation/ownership purposes; {@link #shouldApplyMixin(String, String)}
     * does not gate on it.
     */
    ...
    private static final Set<String> ADVANCED_LOGISTICS_MIXINS = Set.of(
        ...
        "com.yision.fluidlogistics.mixin.item.ClipboardBlockItemMixin",
        ...
        "com.yision.fluidlogistics.mixin.client.FactoryPanelConnectionHandlerMixin",
        ...
        "com.yision.fluidlogistics.mixin.accessor.RedstoneRequesterScreenAccessor",
        "com.yision.fluidlogistics.mixin.client.RedstoneRequesterScreenMixin",
        "com.yision.fluidlogistics.mixin.accessor.StockKeeperRequestScreenAccessor",
