...
public class FluidTransporterFilterSlotPositioning extends ValueBoxTransform.Sided {
    ...
    public void rotate(LevelAccessor level, BlockPos pos, BlockState state, PoseStack ms) {
        ...
        if (side.getAxis() == Direction.Axis.Y) {
            TransformStack.of(ms).rotateYDegrees(180 + AngleHelper.horizontalAngle(transporterFacing));
        }

        TransformStack transform = TransformStack.of(ms).rotateYDegrees(yRot).rotateXDegrees(xRot);
